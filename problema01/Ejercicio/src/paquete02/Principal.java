...
public class Principal {
    ...
    public static void main(String[] args) {
        ...
        OperatoriaTv operatoria = new OperatoriaTv(tvs);
        operatoria.establecerListaTvs(tvs);
        operatoria.establecerTotalPrecioTvs();
        operatoria.establecerTvCaro();
        operatoria.establecerlistaMarcasVendidas();
        operatoria.obtenerlistaMarcasVendidas();
        operatoria.obtenertelevisorMasCaro();
        operatoria.obtenertotalPrecioTvs();
